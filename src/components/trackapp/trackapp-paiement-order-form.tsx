...
/** Bon de commande (placeholder paiement + pays + CTA Stripe) pour une offre fixe mensuelle ou annuelle. */
export function TrackappPaiementOrderForm({
  ...
  const continueLabel =
    busy ? "Ouverture du paiement..." : "Rejoindre";
  ...
  return (
    <div className={`saas-pay-order-inset${className ? ` ${className}` : ""}`}>
